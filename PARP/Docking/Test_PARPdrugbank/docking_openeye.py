...
df_smiles = pd.read_csv('/lus/eagle/projects/candle_aesp/avasan/PARP_TAXOL/PARP/drugbank-all.smi')# smilesdatafile. smiles column is 'smiles'
recep_file = '/lus/eagle/projects/candle_aesp/avasan/PARP_TAXOL/PARP/PDBs/PARP1/7kk5.oedu' # receptor oedu file for openeye 
max_confs = 10 # confs to generate
score_cutoff = 0 # below this score generate pose
...
score_pattern = 'scores/rtcb_scores' #store scores like this (will have #ranks files)
